...
@db_session_injector
def get_calendar(calendar_id: str, db_session: SessionDep) -> ObjCalendarSchemaComplete:
...
@db_session_injector
def edit_calendar(
    calendar_id: str, edited_calendar: ObjCalendarSchemaEdit, db_session: SessionDep
) -> ObjCalendarSchemaComplete:
