...
async def get_all(session: SessionDep) -> List[ObjCalendarSchemaComplete]:
...
async def get(calendar_id: str, session: SessionDep) -> ObjCalendarSchemaComplete:
...
async def delete(calendar_id: str, session: SessionDep):
