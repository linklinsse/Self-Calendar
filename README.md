...
- **[`AI-DISCLOSURE.md`](AI-DISCLOSURE.md)** — this project was started by hand and finished with substantial help from Claude. The file explains what that means in practice, and what it doesn't capture.
...
**CI runs on every push and pull request.** [`.github/workflows/ci.yml`](.github/workflows/ci.yml) runs both suites plus the app build.
...
loadable tars and the Android APK. See [`.github/workflows/release.yml`](.github/workflows/release.yml).
...
explains which parts came from where.
