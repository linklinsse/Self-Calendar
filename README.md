...
- **[`docs/pre-publication-review-2026-08-02.md`](docs/pre-publication-review-2026-08-02.md)** — what to clean up before making the repo public, in order. Start here if that is the current task.
- **[`docs/going-public.md`](docs/going-public.md)** — settings and checks for publishing the repo. Note it opens by explaining that GitHub cannot hide branches in a public repo, and what to do instead.
- **[`docs/reset-main-to-release.md`](docs/reset-main-to-release.md)** — squashing `main` to a single `v1.0.0` commit, with what that destroys.
