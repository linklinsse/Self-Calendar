...
CI can do this too — see `.github/workflows/release.yml` — but it needs the
keystore as a secret, and you have to create the keystore locally first
regardless. This document is that process.
